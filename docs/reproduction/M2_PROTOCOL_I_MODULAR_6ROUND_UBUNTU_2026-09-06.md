...
Revision: `401e647aabc2da68181105d015577917f83f0987` on
`m2-protocol-i-modular-6round`.
...
Actual result: the newly added target was run and passed: `1/1`; target elapsed
`9.77 s`, CTest total `10.09 s`. This record does **not** claim an EMP-OFF or
EMP-ON full-suite count, and it does not turn this one-target run into a
