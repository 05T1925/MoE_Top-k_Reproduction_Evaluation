...
std::vector<std::uint64_t> protocol_i_cmpagg_eval_party(int party, int comparison_bits, const std::vector<std::uint64_t>& masked_keys, std::vector<ProtocolIUcmpMaterial>& edge_materials);
}
