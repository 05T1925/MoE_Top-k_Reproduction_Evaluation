...
// ============================================================================
// CAVERN spline computational core
//
// Current integration:
//   - masked-wire backend
//   - trusted preprocessing dealer
//   - VIDPF token verification
//
// It does not yet include the full SPDZ/FedaBits/tag-VIDPF wrapper in Figure 7.
// ============================================================================
